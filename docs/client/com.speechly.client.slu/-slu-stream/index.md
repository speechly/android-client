//[client](../../index.md)/[com.speechly.client.slu](../index.md)/[SluStream](index.md)



# SluStream  
 [androidJvm] interface [SluStream](index.md) : [Closeable](https://developer.android.com/reference/kotlin/java/io/Closeable.html)
...
|  Name| 
|---|
| <a name="com.speechly.client.slu/GrpcSluStream///PointingToDeclaration/"></a>[GrpcSluStream](../-grpc-slu-stream/index.md)
