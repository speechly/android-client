//[client](../../../index.md)/[com.speechly.client.identity](../../index.md)/[BasicIdentityService](../index.md)/[Companion](index.md)
...
| <a name="com.speechly.client.identity/BasicIdentityService.Companion/forTarget/#kotlin.String#kotlin.Boolean/PointingToDeclaration/"></a>[forTarget](for-target.md)| <a name="com.speechly.client.identity/BasicIdentityService.Companion/forTarget/#kotlin.String#kotlin.Boolean/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>fun [forTarget](for-target.md)(target: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html) = "api.speechly.com", secure: [Boolean](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-boolean/index.html) = true): [BasicIdentityService](../index.md)  <br>More info  <br>Creates a new identity service using default gRPC client implementation.  <br><br><br>
